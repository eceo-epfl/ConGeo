...
from congeo.dataset.cvact import CVACTDatasetTrainConGeo, CVACTDatasetEval, CVACTDatasetTest
...
if __name__ == '__main__':
    ...
    # Train
    train_dataset = CVACTDatasetTrainConGeo(data_folder=config.data_folder ,
